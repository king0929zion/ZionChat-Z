...
val ZionSectionItemPressed = Color(0xFFE5E5EA)
val ZionDivider = Color(0xFFE4E4E4)
val ZionAccentNeutral = Color(0xFF111214)
val ZionAccentNeutralSoft = Color(0xFFF2F2F7)
val ZionAccentNeutralBorder = Color(0xFFE5E5EA)
val ZionAccentBlue = Color(0xFF007AFF)
val ZionSelectedToolBackground = Color(0xFFF2F2F7)
val ZionActionIcon = Color(0xFF1C1C1E)
val ZionToggleActive = Color(0xFF111214)
val ZionUserMessageBubble = Color(0xFFEEEEEE)
val ZionThinkingBackground = Color(0xFFF5F5F5)
val ZionThinkingLabelColor = Color(0xFF8E8E93)
